	...
	const sections: PromptSection[] = [
		...
		},
		{
			...
			lines: [
				...
				'Use source: "cline" when you write the task memory artifact yourself.',
				'',
				...
				'When you write the checkpoint yourself for a successful story, use status: "completed" and source: "cline".',
				'',
	...
	const sections: PromptSection[] = [
		...
		},
		{
			...
			lines: [
				...
				'reviewSummary must include: totalScore, passingScore, passed, reviewPass, maxReviewerPasses, maxAutoRefactorRounds, dimensions, findings, recommendations, refactorPerformed, reviewedAt, and source: "cline".',
