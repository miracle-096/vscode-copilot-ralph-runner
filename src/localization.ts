...
const CHINESE_PACK: RalphLanguagePack = {
	...
	policyConfig: {
		...
		saved: 'RALPH：执行检查、审批提示模式和 Reviewer 配置已更新；若保存到 User，全局值已写入并清除了当前工作区覆盖。',
		openSettings: '打开设置',
		ruleLabels: {
...
const ENGLISH_PACK: RalphLanguagePack = {
	...
	policyConfig: {
		...
		saved: 'RALPH: Run checks, approval mode, and Reviewer settings were updated; saving to User also clears current workspace overrides.',
